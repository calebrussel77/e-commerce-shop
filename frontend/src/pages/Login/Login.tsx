...
const Login = (props: {
  onUserAuthSignIn: (email: string, password: string) => void;
  location: any;
  isLoading: boolean;
  history: any;
  userInfo: IUser;
  ...
  const handleSubmit = (e: any) => {
    e.preventDefault();
    props.onUserAuthSignIn(email, password);
    setPassword("");
  };
...
const mapDispatchToProps = (dispatch: any) => {
  return {
    onUserAuthSignIn: (email: string, password: string) =>
      dispatch(actions.userAuthSignIn(email, password)),
  };
};
