  ...
  const handleSubmitUserProfil = (e: any) => {
    ...
    if (password && password !== password2) {
      ...
      onUpdateUserProfil({
        name,
        website,
        image: previewSource ? previewSource : image,
        email,
        city,
        state,
        zipCode,
                ...
                <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                  ...
                  <div>
                    ...
                    <div className="mt-1 flex items-center">
                      <span className="inline-block h-12 w-12 rounded-full overflow-hidden bg-gray-100 mt-3 md:mt-0 border border-gray-200">
                        <img
