const NotFound = (props: {
  ...
  return (
    <div className="flex flex-col items-center space-y-4 text-center text-gray-500 justify-center">
      <svg className="w-3/4 h-72 mb-2" viewBox="0 0 1116.21 857.08">
        <defs>
          <linearGradient
      ...
      <p className="mt-4 max-w-2xl text-lg leading-7 text-gray-500 mx-auto">
        {props.children}
      </p>
    </div>
  );
