              ...
              <div className="flex items-center justify-center">
                <div className="relative inline-block text-left">
                  <Menu>
                    {({ open }) => (
                      <>
                        <Menu.Button className="hidden md:inline-flex items-center space-x-2 w-full text-sm font-medium leading-5 text-gray-700 transition duration-150 ease-in-out hover:text-gray-500 focus:outline-none focus:border-pink-300 focus:shadow-outline-blue active:bg-gray-50 active:text-gray-800">
                          <img
                            src={props?.userInfo?.image}
                            alt={props?.userInfo?.name}
                            className="rounded-full h-10 w-auto border-2 border-green-600"
                          />
                          <svg
                            ...
                            <div className="px-4 py-3 flex items-start space-x-2">
                              <div className="pt-2">
                                <img
                                  src={props?.userInfo?.image}
                                  alt={props?.userInfo?.name}
                                  className="rounded-full h-7 w-7 border-2 border-green-600"
                                />
                              </div>
                              <div>
